...
def print_statitical_feature():
    ...
    for file in files:
        ...
        w_list += w_split_list
        print('****************'+file+'***********************\n')
        print(np.median(cin_split_list), np.median(cout_split_list), np.median(h_split_list), np.median(w_split_list))
        print(np.mean(cin_split_list), np.mean(cout_split_list), np.mean(h_split_list), np.mean(w_split_list))
